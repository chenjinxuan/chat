...
class CustomVew extends Component<any, any> {
...
export default class TalkSession extends Component<any, any> {
  constructor(props:any) {
    super(props);
    let initHeight;
    if (Platform.OS === "ios") {
  ...
  onInputViewSizeChange = (size:any) => {
  ...
  onStartRecordVoice = (e:any) => {
    console.log("on start record voice")
  }

  onFinishRecordVoice = (mediaPath:any, duration:any) => {
    var message = constructNormalMessage()
  ...
  onShowKeyboard = (keyboard_height:any) => {
  }
   ...
   */
  switchCameraMode = (isRecordVideoMode:any) => {
